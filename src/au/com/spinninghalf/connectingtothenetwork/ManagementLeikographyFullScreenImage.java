...
public class ManagementLeikographyFullScreenImage extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.management_leikography_full_screen_layout);
        
        //get the reference to the ImageView
        ImageView mainImageView = (ImageView) findViewById(R.id.managementLeikographyFullScreenImageView);
        ...
        thumbnailId = extras.getInt(ManagementLeikographyActivity.ARG_SELECTED_IMAGE);
        ...
        position = extras.getInt(ManagementLeikographyActivity.ARG_SELECTED_IMAGE_POSITION);
        
        //get the string array resource containing the photo descriptions
        //then convert it to an actual string array.
        final String[] photoLabels = getResources().getStringArray(R.array.managementLeikographyPhotoLabels);
        ...
        Toast.makeText(ManagementLeikographyFullScreenImage.this, photoLabels[position], Toast.LENGTH_SHORT).show();
