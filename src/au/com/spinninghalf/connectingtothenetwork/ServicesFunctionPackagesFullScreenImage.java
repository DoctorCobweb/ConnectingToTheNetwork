...
public class ServicesFunctionPackagesFullScreenImage extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.services_function_packages_full_screen_layout);
        
        //get the reference to the ImageView
        ImageView mainImageView = (ImageView) findViewById(R.id.servicesFunctionPackagesFullScreenImageView);
        ...
        thumbnailId = extras.getInt(ServicesFunctionPackagesActivity.ARG_SELECTED_IMAGE);
        ...
        position = extras.getInt(ServicesFunctionPackagesActivity.ARG_SELECTED_IMAGE_POSITION);
        
        //get the string array resource containing the photo descriptions
        //then convert it to an actual string array.
        final String[] photoLabels = getResources().getStringArray(R.array.servicesFunctionPackagesPhotoLabels);
        ...
        Toast.makeText(ServicesFunctionPackagesFullScreenImage.this, photoLabels[position], Toast.LENGTH_SHORT).show();
